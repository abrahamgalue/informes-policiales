...
class MostrarPersonas(tk.Tk):
    ...
    def inicializar_gui(self):
        ...
        bg_file = './src/img/personas_show.png'
        ...
        self.tree.column('Nacimiento',width=195, minwidth=195, stretch=False)
        self.tree.column('Arrestos',width=177, minwidth=177, anchor=tk.CENTER, stretch=False)
        ...
        from .util.persona import get_personas   
        implicado_data = get_personas()    
